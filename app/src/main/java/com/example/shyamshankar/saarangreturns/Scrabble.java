...
public class Scrabble extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email.setOnClickListener(new View.OnClickListener(){
            ...
            public  void onClick(View v)
            {
                ...
                emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Inquiry about Scrabble");
    ...
    public void CalendarClick(View view){
        ...
        long endTime= calendar.getTimeInMillis() + 90*60*1000;

        intent.putExtra(CalendarContract.EXTRA_EVENT_BEGIN_TIME, startTime);
        intent.putExtra(CalendarContract.EXTRA_EVENT_END_TIME,endTime);
        intent.putExtra(CalendarContract.EXTRA_EVENT_ALL_DAY, false);

        intent.putExtra(CalendarContract.Events.TITLE, "Scrabble Reminder");
        intent.putExtra(CalendarContract.Events.DESCRIPTION,  "Reach CRC on time for Scrabble");
